...
const page = () => {
  ...
  return (
    <body className="relative font-inter antialiased">
      <main className="relative min-h-screen flex flex-col bg-slate-900 overflow-hidden">
              ...
              <div className="relative h-full bg-slate-900 p-6 pb-8 rounded-[inherit] z-20 overflow-hidden">
                ...
                <div className="flex flex-col justify-center h-full items-center text-center gap-1">
                  ...
                  <div className="flex flex-col items-start justify-start gap-1 w-full h-full">
                    <h2 className="text-slate-200 text-4xl m-0 font-bold">
                      Hi, I&apos;m{" "}
                      <span className="text-slate-500">Sajjad</span>.
                    </h2>
                    <h2 className="text-slate-500 text-md m-0 font-bold">
                      web developer
                    </h2>
                    <h2 className="text-slate-200 text-2xl m-0 font-semibold mt-4 text-left">
                      Passionate to pursue the technology.
                    </h2>
                    <h2 className="text-slate-500 text-lg m-0 mt-4 text-left">
                  ...
                  {/* <div className="grow mb-5">
                    <h2 className="text-slate-200 text-4xl m-0 font-extrabold">
                      Hi, I&apos;m{" "}
